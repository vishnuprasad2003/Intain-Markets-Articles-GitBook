...
description: How to use Asset Analysis, Risk Surveillance, and Reports inside an Asset Sale deal
---
...
![Asset Analysis Overview](images/39-asset-sale-analytics/asset-analysis-overview.png)

![Asset Analysis Receivables](images/39-asset-sale-analytics/asset-analysis-receivables.png)
