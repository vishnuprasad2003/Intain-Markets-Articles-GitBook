...
description: Complete guide to the token approval workflow in credit facility funding notices, from token generation through borrower approval to lender settlement
---
...
![Issuer Token Approval](images/45-token-approval/Issuer_Token_Approval.png)
