...
* Your term sheet status shows **CHANGES\_REQUESTED**
...
1. **Check Dashboard**
   ...
   * Find your term sheet with status **CHANGES\_REQUESTED**
...
![Review Changes Requested - Issuer](<.gitbook/assets/ReviewChangesRequestedIssuer (1).png>)
...
![Submit Term Sheet to FA](<.gitbook/assets/SubmitTermSheetToFA (1).png>)
...
* Request more changes → CHANGES\_REQUESTED (repeat process)

## Rules & Validations

* **Only CHANGES\_REQUESTED Can Edit**: You can only edit term sheets when they're in CHANGES\_REQUESTED status.
...
* Status changes back to CHANGES\_REQUESTED
* Repeat the edit, sign, and submit process

![Review Term Sheet Fa](<.gitbook/assets/review_term_sheet_FA (1).png>)
