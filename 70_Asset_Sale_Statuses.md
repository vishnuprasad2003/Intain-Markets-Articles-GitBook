...
description: Canonical reference for all asset sale deal statuses — exact status values from the codebase, their meanings, who can act, available actions, and transitions
---
