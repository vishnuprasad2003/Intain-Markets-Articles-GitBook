---
title: Pool Details Analytics
description: Review deal analytics, stratifications, performance, and loan-level details for a single pool
---
...
![Pool Summary](images/14-analytics/pool-summary.png)

### Pool Strats

![Pool Strats](images/14-analytics/pool-strats.png)

### Pool Performance

![Pool Performance](images/14-analytics/pool-performance.png)

### Pool Asset Tape

![Pool Asset Tape](images/14-analytics/pool-asset-tape.png)

## Asset Analysis Screenshots

### Asset Analysis Overview

![Asset Analysis Overview](images/14-analytics/asset-analysis-overview.png)

### Asset Analysis Strats

![Asset Analysis Strats](images/14-analytics/asset-analysis-strats.png)

### Asset Analysis Performance

![Asset Analysis Performance](images/14-analytics/asset-analysis-performance.png)

## Risk Analytics

### Risk Overview

![Risk Overview](images/14-analytics/risk-overview.png)
