...
**What this means:** This is the one rejection that protects the original item. The issuer is declining a removal request, so the loan remains. The market maker or investor can still leave comments. They cannot force the loan out of the pool.
...
**What this means:** The decline applies to that lender on that notice. It does not reject the notice for the other lenders, and it does not by itself close the notice.
