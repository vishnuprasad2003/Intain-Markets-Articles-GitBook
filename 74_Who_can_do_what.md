...
## Asset Sale Permissions

### Issuer Actions (Asset Sale)
...
| Initiate Repayment | Deal status: Settled |

### Underwriter Actions (Asset Sale)

| Action | When Available |
|--------|----------------|
| Review Deal | When deal is published |
| Approve Deal | After review |
| Reject Deal | After review |
| Manage Allocation | After deal approval |

### Investor Actions (Asset Sale)

| Action | When Available |
|--------|----------------|
| Commit to Deal | Deal status: Approved |
| Sign Agreement | After commitment |
| Confirm Settlement | After agreement signed |
| Confirm Repayment | When repayment initiated |
| Burn NFTs | After repayment confirmed |

### Servicer Actions (Asset Sale)

| Action | When Available |
|--------|----------------|
| Upload Loan Tape | For assigned deals |
