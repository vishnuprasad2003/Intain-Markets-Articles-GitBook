...
description: >-
  Complete task-based guide for issuers to initiate repayment — covering the
  four-step wizard, payment rail selection, repayment type cards, amount
  validation, wire reference, document upload, and confi
---
