...
1. **Check Dashboard**
   * Term sheet status shows **CHANGES\_REQUESTED**
...
| CHANGES\_REQUESTED | Facility agent requested modifications      | Edit, sign, resubmit             |
...
* **No Edit After Submission**: You cannot edit term sheets while they're in FAReview status. You can only edit in Draft or CHANGES\_REQUESTED status.
