...
![Accessing Term Sheet - Create New Term Sheet](images/18-term-sheet-workflow/AccessingTermsheetCreateNewTermSheet.png)
...
![Add Term Sheet Details](images/18-term-sheet-workflow/2_AddTermSheetDetails.png)
...
![Upload Documents](images/18-term-sheet-workflow/UploadDocuments.png)
...
![Issuer - Term Sheet Creation](images/18-term-sheet-workflow/Issuer_TermSheetCreation.png)
...
![Submit Term Sheet to FA](images/18-term-sheet-workflow/SubmitTermSheetToFA.png)
...
![Review Term Sheet - FA](images/18-term-sheet-workflow/review_term_sheet_FA.png)
...
![Review Changes Requested - Issuer](images/18-term-sheet-workflow/ReviewChangesRequestedIssuer.png)
