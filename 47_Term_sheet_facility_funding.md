...
This comprehensive reference guide explains all statuses for credit facility components: Term Sheets, Master Commitments (Facilities), Funding Requests, and Funding Notices. Each component has its own status progression that reflects where it is in the workflow.
