...
![Term Sheet Creation - Issuer](.gitbook/assets/Issuer_TermSheetCreation.png)
...
* **Request Changes**: Status changes to **CHANGES\_REQUESTED**, borrower can edit and resubmit
...
![Credit Facility - Lender Approve](.gitbook/assets/CreditFacility_Lender_Approve.png)
...
* **Reject**: Status changes to **Rejected**
* **Request Changes**: Status changes to **CHANGES\_REQUESTED**
...
![FundTransferConfirmation](.gitbook/assets/FundTransferConfirmation.png)

![LenderApprovalFundingNotice](.gitbook/assets/LenderApprovalFundingNotice.png)

![Cf Cashflow Simulation](.gitbook/assets/cf-cashflow-simulation.png)

![Cf Dashboard](.gitbook/assets/cf-dashboard.png)

![Cf Funding Operations](.gitbook/assets/cf-funding-operations.png)

![Credit Facility Active Facilities Tab Issuer](.gitbook/assets/credit_facility_active_facilities_tab_issuer.png)
...
**RemoteV2 Deal Creation Wizard** - The facility agent now uses a RemoteV2 Deal Creation wizard with 11 tabs for comprehensive deal setup: General, Facilities, Fees, Expenses, Manual Inputs, Accounts, Triggers, Borrowing Base, Calculations, Waterfall, and Review. This replaces the earlier deal modelling setup flow.

**Credit Facility Analytics** - Credit facility analytics are available through remote dashboards including Funding Analytics, Borrowing Base Analytics, Payment Analytics, Strats, Performance, Loans, Risk Overview, Covenants, Concentration, Data Checks, and Triggers. These dashboards provide comprehensive visibility into facility performance and compliance.

**E-Signature Providers** - E-signature now supports both **Adobe Sign** and **ZohoSign**. DocuSign has been retired. Both providers use a shared e-signature architecture with consistent workflows.
