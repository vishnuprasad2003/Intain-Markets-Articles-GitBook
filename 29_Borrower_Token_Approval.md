...
**What the approval does:** Your wallet approves the platform to transfer the tokens for this draw. That approval is recorded on the blockchain, the shared digital ledger that tracks the tokens. The funding notice keeps a record of the approval.
