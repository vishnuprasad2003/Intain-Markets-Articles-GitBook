...
3. **Review Lender Distribution**
   ...
   - **Individual Lender Allocations**: See each lender's portion
   - **Distribution Percentages**: Check percentages match facility participation
   - **Lender Names**: Verify all lenders are included
   - **Allocation Amounts**: Confirm each lender's amount is correct
...
4. **Complete Approval**
   ...
   - Status updates to show token approval (e.g., "TOKEN_APPROVED")
   - Funding notice becomes visible to lenders
   - Lenders receive notifications

5. **Verify Approval Completion**
   - Confirm status shows approval is complete
