...
The platform now supports two e-signature providers: **Adobe Sign** and **ZohoSign**. DocuSign is no longer supported. Both providers use a shared e-signature architecture with consistent workflows across all signing points. Mock signing is available in test/UAT environments for development purposes.
...
**Adobe Sign and ZohoSign Integration** - E-signatures use either Adobe Sign or ZohoSign for secure, legally compliant signing. DocuSign has been retired.
