...
**When It Happens:**
After the borrower completes a term sheet and clicks **Create Draft**, the e-signature process begins automatically.
...
**When It Happens:**
When a lender reviews a master commitment in their Opportunities section and clicks **Approve & E-Sign** to formally approve and commit to the credit facility.
...
**Per-Lender Tracking:**
Each lender in the master commitment has individual e-sign tracking:
...
**When It Happens:**
After a funding request is approved and a funding notice is automatically generated, the facility agent must individually e-sign the notice for each participating lender.
...
The E-sign counter provides real-time visibility into the signing progress:
